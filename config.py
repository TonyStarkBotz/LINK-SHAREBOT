...
BOT_USERNAME = 'MTLinksShareBot'
APP_ID = int(os.environ.get("APP_ID", ""))
API_HASH = os.environ.get("API_HASH", "")
OWNER_ID = int(os.environ.get("OWNER_ID", "5019668523"))
PORT = os.environ.get("PORT", "8080")
DB_URL = os.environ.get("DB_URI", "")
DB_NAME = os.environ.get("DB_NAME", "Digital-link")
TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "40"))
COMMAND_PHOTO = os.environ.get("COMMAND_PHOTO", "https://i.ibb.co/fYgpDNYD/photo-2026-01-01-11-10-18-7590348956073197584.jpg")  # Replace with your photo URL
START_PIC = os.environ.get("START_PIC", "https://i.ibb.co/yc3zHDHz/photo-2026-01-01-11-13-30-7590349729167310864.jpg")
...
ABOUT_TXT = os.environ.get("HELP_MESSAGE", "<i><b><blockquote>◈ ᴄʀᴇᴀᴛᴏʀ: <a href=https://t.me/DigitalGalaxyHQ>Ƭᴏɴʏ Ꮪᴛᴀʀᴋ ⎊</a>\n◈ ꜰᴏᴜɴᴅᴇʀ ᴏꜰ : <a href=https://t.me/MOViETiMESTV>MOViETiMESTV</a>\n◈ ᴅᴇᴠᴇʟᴏᴘᴇʀ: <a href='https://t.me/DigitalGalaxyHQ'>DigitalGalaxyHQ</a>\n◈ ᴅᴀᴛᴀʙᴀsᴇ: <a href='https://www.mongodb.com/docs/'>ᴍᴏɴɢᴏ ᴅʙ</a>\n» ᴅᴇᴠᴇʟᴏᴘᴇʀ: <a href='https://t.me/about_zani/179'>ZANI</a></blockquote></b></i>")
...
FSUB_PIC = os.environ.get("FSUB_PIC", "https://i.ibb.co/zVxxB8xR/photo-2026-01-01-11-10-05-7590348895943655428.jpg")
FSUB_LINK_EXPIRY = 300
LOG_FILE_NAME = "Rexbots.txt"
DATABASE_CHANNEL = int(os.environ.get("DATABASE_CHANNEL", "-1002210669265"))
